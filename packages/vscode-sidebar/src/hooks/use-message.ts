...
interface MessageType { from?: string, value?: any } // Webview 之间的君子约定，没有规定
...
// 发送消息
function sendMessage(channel: string, value: any) {
...
async function listeningMessage(listener: (value?: any, from?: string) => void) {
