import type { FilterApiConfig } from '@/plugins/presets/filterApi'
import type { ApiDescriptor } from '@/type'
import { resolve } from 'node:path'
import { apiFilter, filterApiDescriptor } from '@/plugins/presets/filterApi'
...
describe('apiFilter plugin tests', () => {
  ...
  describe('basic filtering functionality', () => {
    it('should include APIs when URL contains specified string', () => {
    ...
    it('should exclude APIs when URL contains specified string', () => {
    ...
    it('should work with function matchers', () => {
  ...
  describe('different scope tests', () => {
    it('should filter by URL scope (default)', () => {
    ...
    it('should filter by tag scope with multiple tags', () => {
    ...
    it('should exclude by tag scope', () => {
    ...
    it('should handle API with no tags when filtering by tag scope', () => {
  ...
  describe('multiple configuration union logic tests', () => {
    it('should apply union logic with multiple include configs', () => {
    ...
    it('should apply union logic with mixed scope configs', () => {
    ...
    it('should apply union logic with include and exclude configs', () => {
    ...
    it('should work with complex union conditions', () => {
      const configs: FilterApiConfig[] = [
  ...
  describe('edge case tests', () => {
    ...
    it('should return null when API descriptor is undefined', () => {
      const config: FilterApiConfig = { include: 'user' }
    ...
    it('should handle null exclude rule (should include all)', () => {
    ...
    it('should handle null include rule with exclude', () => {
  ...
  describe('error handling tests', () => {
    it('should throw error when neither include nor exclude is specified', () => {
      const config: FilterApiConfig = {}
    ...
    it('should throw error for multiple configs when none have include or exclude', () => {
    ...
    it('should throw error when one config in array is invalid', () => {
      const configs: FilterApiConfig[] = [
        { include: 'user' },
    ...
    it('should work when at least one valid config exists in single config', () => {
      const config: FilterApiConfig = { include: 'user' }
    ...
    it('should work when all configs in array are valid', () => {
      const configs: FilterApiConfig[] = [
        { include: 'user' },
        { exclude: 'internal' },
    ...
    it('should handle function matcher that throws error gracefully', () => {
      const config: FilterApiConfig = {
        include: (url: string) => {
  ...
  describe('integration tests', () => {
    it('should filter APIs by URL in real generation process', async () => {
    ...
    it('should filter APIs by excluding specific patterns', async () => {
      const { apiDefinitionsFile } = await generateWithPlugin(resolve(__dirname, '../openapis/openapi_300.yaml'), [
    ...
    it('should apply union logic with multiple configs in real generation', async () => {
      const { apiDefinitionsFile } = await generateWithPlugin(resolve(__dirname, '../openapis/openapi_300.yaml'), [
    ...
    it('should work with regex patterns in real generation', async () => {
      const { apiDefinitionsFile } = await generateWithPlugin(resolve(__dirname, '../openapis/openapi_300.yaml'), [
        apiFilter({ include: /^\/pet/ }),
      ])
