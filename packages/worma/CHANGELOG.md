...
- [#197](https://github.com/alovajs/devtools/pull/197) [`18480c9`](https://github.com/alovajs/devtools/commit/18480c9145076239954968c47ff1f3ba43d4795d) Thanks [@JOU-amjs](https://github.com/JOU-amjs)! - Add change-record removal and make incremental rendering self-heal.
  ...
  - The `aiDoc` plugin deletes the generated skill directory under the output directory once _every_ target agent installed successfully, so the skill is no longer stored twice. A failing install throws before the cleanup and therefore keeps the source directory.
