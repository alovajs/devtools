 ...
 */
/**
 * @typedef {{ [P in keyof typeof import('./apiDefinitions')]?: MethodConfig<P extends `${infer Tag}.${infer Url}` ? Parameters<Parameters<Apis[Tag][Url]>[0]['transformData']>[0] : any> }} MethodsConfigMap
 */
/**
