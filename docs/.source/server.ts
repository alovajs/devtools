...
import * as __fd_glob_25 from "../content/docs/plugin-system/index.mdx?collection=docs"
import * as __fd_glob_24 from "../content/docs/plugin-system/examples.mdx?collection=docs"
import * as __fd_glob_23 from "../content/docs/plugin-system/custom-plugin.mdx?collection=docs"
import * as __fd_glob_22 from "../content/docs/template-system/predefined-templates.mdx?collection=docs"
import * as __fd_glob_21 from "../content/docs/template-system/index.mdx?collection=docs"
import * as __fd_glob_20 from "../content/docs/template-system/custom-templates.mdx?collection=docs"
