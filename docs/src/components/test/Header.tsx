    ...
    <header className="bg-background/80 backdrop-blur-xl sticky top-0 z-50 tech-border-b">
      <Container border="all" className="flex justify-between items-center w-full px-6 py-4">
        ...
        <nav className="hidden md:flex items-center gap-12">
          <a className="font-data-mono text-xs uppercase tracking-widest text-primary" href="#">// Features</a>
          <a className="font-data-mono text-xs uppercase tracking-widest text-on-surface-variant hover:text-primary transition-colors" href="#">// Plugins</a>
          <a className="font-data-mono text-xs uppercase tracking-widest text-on-surface-variant hover:text-primary transition-colors" href="#">// Matrix</a>
          <a className="font-data-mono text-xs uppercase tracking-widest text-on-surface-variant hover:text-primary transition-colors" href="#">// Docs</a>
        </nav>
