...
import { rename, globals, functional } from '@alova/wormhole/plugin';
...
```JavaScript
import { alova } from '@alova/wormhole/plugin';
...
```JavaScript
import { alovaGlobals } from '@alova/wormhole/plugin';
...
```JavaScript
import { axios } from '@alova/wormhole/plugin';
...
```JavaScript
import { fetch } from '@alova/wormhole/plugin';
...
```JavaScript
import { ky } from '@alova/wormhole/plugin';
...
| 环境变量                      | 说明                             |
| ----------------------------- | -------------------------------- |
| `WORMHOLE_WORKERS=auto\|N\|0` | 覆盖 `performance.workerPool`    |
| `WORMHOLE_PRETTIER=0\|1`      | 覆盖 `performance.prettierFinal` |
