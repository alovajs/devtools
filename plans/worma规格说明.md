...
- `worma/plugin` → 现有 `rename`、`apifox`、`importType`、`filterApi`、`tagModifier`、`payloadModifier`、**新增 `aiDoc`**、**新增模板预设插件 `alova`、`alovaGlobals`、`axios`、`fetch`、`ky`**、**新增 `platform`**。
